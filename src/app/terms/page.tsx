...
export const metadata = {
  title: 'Terms of Use | Lirrivelle',
  description: 'Complete terms and conditions for using Lirrivelle',
};
      ...
      <div className="bg-white rounded-xl shadow-sm p-8 sm:p-10">
        ...
        <div className="prose prose-lg max-w-none">
          <section className="mb-10">
            ...
            <p className="mb-4">
              Lirrivelle is a carefully curated collection of content I&apos;ve gathered to create a peaceful online space. By accessing or using this website, you acknowledge that you have read, understood, and agree to be bound by these Terms of Use and our{' '}
              <Link href="/privacy-policy" className="text-pink-600 hover:underline">
                Privacy Policy
              </Link>
              . If you don&apos;t agree with any part of these terms, please refrain from using our site.
            </p>
            <p>
          ...
          <section className="mb-10">
            ...
            <p className="mb-4">The content on Lirrivelle falls into several categories regarding ownership and usage rights:</p>
            <ul className="list-disc pl-6 mb-4 space-y-3">
              <li>
                <strong>Original content</strong> created by me is free for personal, non-commercial use with attribution
              </li>
              <li>
                <strong>Shared content</strong> from other creators is used with permission or under fair use principles
              </li>
              <li>
                <strong>Public domain content</strong> is clearly marked when possible
              </li>
              <li>
                <strong>User-submitted content</strong> (when applicable) remains property of the original creator
              </li>
            </ul>
            <p>
              ...
              immediately with details and we&apos;ll address your concerns promptly.
            </p>
          </section>

          <section className="mb-10">
            <h2 className="text-xl sm:text-2xl font-semibold mb-4 text-pink-500">Permitted Uses of Our Content</h2>
            <p className="mb-4">You&apos;re welcome to:</p>
            <ul className="list-disc pl-6 mb-4 space-y-3">
            ...
            <p>
              ...
              to understand what data we collect and how we use it when you interact with our site.
            </p>
          </section>

          <section className="mb-10">
            <h2 className="text-xl sm:text-2xl font-semibold mb-4 text-pink-500">Prohibited Activities</h2>
            <p className="mb-4">To maintain the quality and integrity of Lirrivelle, we prohibit:</p>
            <ul className="list-disc pl-6 mb-4 space-y-3">
            ...
            <p>Violations may result in restricted access to our site and possible legal action where appropriate.</p>
          </section>

          <section className="mb-10">
            <h2 className="text-xl sm:text-2xl font-semibold mb-4 text-pink-500">Content Submission Policy</h2>
            <p className="mb-4">
            ...
            <p>
              If you&apos;re interested in collaborating or having your work considered for inclusion, please{' '}
              <Link href="/contact" className="text-pink-600 hover:underline">
                contact us
              </Link>{' '}
              with details about your content and how you&apos;d like it to be featured.
            </p>
          </section>

          <section className="mb-10">
            <h2 className="text-xl sm:text-2xl font-semibold mb-4 text-pink-500">Third-Party Links and Content</h2>
            <p className="mb-4">
            ...
            <p>When leaving our site, we recommend reviewing the terms and privacy policies of any third-party sites you visit.</p>
          </section>

          <section className="mb-10">
            <h2 className="text-xl sm:text-2xl font-semibold mb-4 text-pink-500">Changes to These Terms</h2>
            <p className="mb-4">
